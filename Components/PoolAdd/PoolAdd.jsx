                ...
                <div className={Style.PoolAdd_box_header}>
                    ...
                    <div className={Style.PoolAdd_box_header_right}>
                        <p>
                            ...
                            {""}
                            {tokenTwo.name || ""}{" "}
                            {tokenTwo.tokenBalance.slice(0, 9) || ""} {""}
                            {""}
                        </p>
                        <Image
                            src={images.close}
                ...
                <div className={Style.PoolAdd_box_price}>
                    ...
                    <div className={Style.PoolAdd_box_price_left}>
                        ...
                        <div className={Style.PoolAdd_box_price_left_fee}>
                            <div
                                className={
                                    Style.PoolAdd_box_price_left_fee_left
                                }
                            >
                                <h4>Fee teir</h4>
                                <p> The % you will earn fees</p>
                            </div>
                            {openFee ? (
                        ...
                        <div className={Style.PoolAdd_box_deposit}>
                            ...
                            <div className={Style.PoolAdd_box_deposit_box}>
                                <input
                                    type="number"
                                    placeholder={tokenOne.tokenBalance.slice(
                                        0,
                                        9
                                    )}
                                    onChange={(e) =>
                            ...
                            <div className={Style.PoolAdd_box_deposit_box}>
                                <input
                                    type="number"
                                    placeholder={tokenTwo.tokenBalance.slice(
                                        0,
                                        9
                                    )}
                                    onChange={(e) =>
                    ...
                    <div className={Style.PoolAdd_box_price_right}>
                        ...
                        <div className={Style.PoolAdd_box_price_right_box}>
                            ...
                            >
                                Current Price: 41.1494 {tokenOne.name || "ETH"}{" "}
                                per {tokenTwo.name || "Select"}
                            </p>
                            <Image
                                src={images.wallet}
                                alt="wallet"
